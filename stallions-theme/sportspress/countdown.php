...
if ( $title )
	echo '<h4 class="sp-table-caption" style="text-align:center">' . $title . '</h4>';
...
?>
<div class="sp-template sp-template-countdown" style="margin:0; padding:0;">
	...
	<?php } ?>
		...
		?>
		<p class="countdown sp-countdown<?php if ( $days >= 10 ): ?> long-countdown<?php endif; ?>" style="padding: 0; margin:0;">
